    ...
    >
      ...
      {showLog && (
        <div
          ...
          style={{ bottom: '12px', left: 0, right: 0, marginInline: 'auto', width: 'min(340px, calc(100vw - 24px))', height: 'min(320px, calc(100dvh - 90px))', display: 'flex', flexDirection: 'column' }}
        >
          <div className="panel-header bg-[#151a30] flex items-center justify-between">
